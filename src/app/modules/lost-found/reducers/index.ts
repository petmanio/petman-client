...
export const getIsListLoaded = createSelector(getEntitiesState, fromLostFound.getIsListLoaded);
export const {
  selectIds: getIds,
 ...
 * LostFound add Page
 */
export const getLostFoundCreatePageState = createSelector(getLostFoundState, (state: State) => state.lostFoundCreatePage);
export const getLostFoundCreatePageError = createSelector(getLostFoundCreatePageState, fromLostFoundCreatePage.getError);
export const getLostFoundCreatePagePending = createSelector(getLostFoundCreatePageState, fromLostFoundCreatePage.getPending);

/**
 * LostFound edit Page
 */
export const getLostFoundUpdatePageState = createSelector(getLostFoundState, (state: State) => state.lostFoundUpdatePage);
export const getLostFoundUpdatePageError = createSelector(getLostFoundUpdatePageState, fromLostFoundUpdatePage.getError);
export const getLostFoundUpdatePagePending = createSelector(getLostFoundUpdatePageState, fromLostFoundUpdatePage.getPending);
