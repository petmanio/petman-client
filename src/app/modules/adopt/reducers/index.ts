 ...
 * Adopt create page
 */
export const getAdoptCreatePageState = createSelector(
  getAdoptState,
  (state: State) => state.adoptCreatePage
);
export const getAdoptCreatePageError = createSelector(
  getAdoptCreatePageState,
  fromAdoptCreatePage.getError
);
export const getAdoptCreatePagePending = createSelector(
  getAdoptCreatePageState,
  fromAdoptCreatePage.getPending
);

/**
 * Adopt update page
 */
export const getAdoptUpdatePageState = createSelector(
  getAdoptState,
  (state: State) => state.adoptUpdatePage
);
export const getAdoptUpdatePageError = createSelector(
  getAdoptUpdatePageState,
  fromAdoptUpdatePage.getError
);
export const getAdoptUpdatePagePending = createSelector(
  getAdoptUpdatePageState,
  fromAdoptUpdatePage.getPending
);

/**
 * Adopt list Page
 */
export const getAdoptListPageState = createSelector(
  getAdoptState,
  (state: State) => state.adoptListPage
);
export const getAdoptListPageError = createSelector(
  getAdoptListPageState,
  fromAdoptListPage.getError
);
export const getAdoptListPagePending = createSelector(
  getAdoptListPageState,
  fromAdoptListPage.getPending
);
