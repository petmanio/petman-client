 ...
 * Sitter create page
 */
export const getSitterCreatePageState = createSelector(
  getSitterState,
  (state: State) => state.sitterCreatePage
);
export const getSitterCreatePageError = createSelector(
  getSitterCreatePageState,
  fromSitterCreatePage.getError
);
export const getSitterCreatePagePending = createSelector(
  getSitterCreatePageState,
  fromSitterCreatePage.getPending
);

/**
 * Sitter update page
 */
export const getSitterUpdatePageState = createSelector(
  getSitterState,
  (state: State) => state.sitterUpdatePage
);
export const getSitterUpdatePageError = createSelector(
  getSitterUpdatePageState,
  fromSitterUpdatePage.getError
);
export const getSitterUpdatePagePending = createSelector(
  getSitterUpdatePageState,
  fromSitterUpdatePage.getPending
);

/**
 * Sitter list Page
 */
export const getSitterListPageState = createSelector(
  getSitterState,
  (state: State) => state.sitterListPage
);
export const getSitterListPageError = createSelector(
  getSitterListPageState,
  fromSitterListPage.getError
);
export const getSitterListPagePending = createSelector(
  getSitterListPageState,
  fromSitterListPage.getPending
);
