...
const routes: Routes = [
  ...
  { path: 'pois', loadChildren: './modules/poi/poi.module#PoiModule', data: { showSidenav: true } },
  { path: 'map', loadChildren: './modules/map/map.module#MapModule', data: { showSidenav: true, hideFooter: true } },
